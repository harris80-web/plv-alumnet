...
@section('content')
    ...
    <h1 style="margin:0 0 20px 0; font-family:'Montserrat', Arial, sans-serif; font-size:26px; line-height:1.3; font-weight:800; text-align:center;">
        <span style="color:#0E0F3B; background:linear-gradient(90deg, #0E0F3B 0%, #C73D1A 50%, #ED7A07 100%); -webkit-background-clip:text; background-clip:text; -webkit-text-fill-color:transparent;">Registration Not Approved</span>
    </h1>
        ...
        <tr>
            <td align="center" style="padding:10px 16px;">
                <p style="margin:0; font-family:'Inter', Arial, sans-serif; font-size:12px; line-height:1.5; font-weight:600; color:#C73D1A; text-align:center;">
                    ...
                    <span style="vertical-align:middle;">Your registration details have been removed from our system. You're welcome to re-apply once the noted issue has been addressed.</span>
                </p>
            </td>
        </tr>
    </table>
