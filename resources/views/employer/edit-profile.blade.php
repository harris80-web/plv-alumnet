            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-6xl font-['Montserrat']">
                ...
                <section class="bg-white rounded-3xl border border-gray-100 shadow-md p-10 flex flex-col items-center">
                    ...
                    <div class="grid grid-cols-2 gap-4 w-full">
                        ...
                        <div>
                            <input type="text" name="employer_industry" placeholder="E.G. TECHNOLOGY" class="w-full px-4 py-1.5 border border-[#0E0F3B] rounded-lg text-gray-800 text-md font-medium uppercase focus:border-[#C73D1A] focus:ring-0 outline-none transition placeholder-gray-400 text-center">
