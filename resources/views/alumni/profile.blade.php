                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-y-6 gap-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-lg text-gray-600 font-medium">
                                {{ $user->alumnus->program->program_name ?? '--' }}
                            </p>
                        </div>
                        <div>
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-sm font-medium text-red-800">
                    <span id="completeness-label">{{ $resumeData['resume_completeness'] ?? 0 }}</span>% complete
                </span>
            </div>
...
(function () {
    ...
    /* ---- submit: this is the ONLY place the completeness bar updates ---- */
    function submitForm(isFinal) {
        ...
        .then(function (data) {
            // The bar only ever moves here — after the server confirms
