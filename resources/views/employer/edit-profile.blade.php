            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-6xl font-['Montserrat']">
                ...
                <section class="bg-white rounded-3xl border border-gray-100 shadow-md p-10 flex flex-col items-center">
                    ...
                    <div class="w-full space-y-6">
                        <div>
                            <input type="text" name="user_first_name" placeholder="Enter full name..." class="w-full px-4 py-1.5 border border-[#0E0F3B] rounded-lg text-lg font-medium text-black focus:border-[#C73D1A] focus:ring-0 outline-none transition placeholder-gray-400">
                            <p class="text-[11px] font-bold text-[#12123B] uppercase tracking-tighter mt-1">Employer First Name</p>
                            <input type="text" name="user_middle_name" placeholder="Enter full name..." class="w-full px-4 py-1.5 border border-[#0E0F3B] rounded-lg text-lg font-medium text-black focus:border-[#C73D1A] focus:ring-0 outline-none transition placeholder-gray-400">
                            <p class="text-[11px] font-bold text-[#12123B] uppercase tracking-tighter mt-1">Employer Middle Name</p>
                            <input type="text" name="user_last_name" placeholder="Enter full name..." class="w-full px-4 py-1.5 border border-[#0E0F3B] rounded-lg text-lg font-medium text-black focus:border-[#C73D1A] focus:ring-0 outline-none transition placeholder-gray-400">
                            <p class="text-[11px] font-bold text-[#12123B] uppercase tracking-tighter mt-1">Employer Last Name</p>
                            <input type="text" name="user_suffix" placeholder="Enter full name..." class="w-full px-4 py-1.5 border border-[#0E0F3B] rounded-lg text-lg font-medium text-black focus:border-[#C73D1A] focus:ring-0 outline-none transition placeholder-gray-400">
                            <p class="text-[11px] font-bold text-[#12123B] uppercase tracking-tighter mt-1">Employer Suffix</p>
                        </div>
                ...
                <section class="bg-white rounded-3xl border border-gray-100 shadow-md p-10 flex flex-col items-center">
                    ...
                    <div class="w-40 h-40 flex flex-col items-center justify-center mb-4 border border-[#0E0F3B] border-dashed rounded-2xl bg-slate-50 hover:bg-slate-100 transition cursor-pointer">
                        ...
                        <input type="file" name="employer_company_logo" id="" accept="image/*">
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 w-full">
                        ...
                        <div>
                            <select name="industry" placeholder="e.g. Technology" class="w-full px-4 py-1.5 border border-[#0E0F3B] rounded-lg text-gray-800 text-md font-medium uppercase focus:border-[#C73D1A] focus:ring-0 outline-none transition placeholder-gray-400 text-center">
                                <option value="" hidden selected disabled>Select Industry</option>
