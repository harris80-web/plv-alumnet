...
@section('preheader', 'Your PLV-AlumNet employer account has been deactivated.')
...
@section('content')
    ...
    <h1 style="margin:0 0 20px 0; font-family:'Montserrat', Arial, sans-serif; font-size:28px; line-height:1.3; font-weight:800; text-align:center;">
        <span style="color:#0E0F3B;">Account </span><span style="color:#DC2626; background:linear-gradient(90deg,#DC2626,#F87171); -webkit-background-clip:text; background-clip:text; -webkit-text-fill-color:transparent;">Deactivated</span>
    </h1>
    ...
    <p style="margin:0 0 24px 0; font-size:14px; line-height:1.6; color:#4B4B63; text-align:center;">
        Your PLV-AlumNet employer account has been deactivated by our administrators for the following reason:
    </p>
        ...
        <tr>
            <td align="center" style="padding:14px 18px;">
                <p style="margin:0; font-size:13px; line-height:1.5; font-weight:600; color:#C73D1A; text-align:center;">
                    If you believe this was a mistake, please contact the PLV-AlumNet Alumni Relations Office.
                </p>
            </td>
        </tr>
    </table>
