...
@section('title', "You're Hired!")
@section('preheader', 'Congratulations — you have been hired!')
...
@section('content')
    ...
    <h1 style="margin:0 0 20px 0; font-family:'Montserrat', Arial, sans-serif; font-size:28px; line-height:1.3; font-weight:800; text-align:center;">
        <span style="color:#0E0F3B;">You're </span><span style="color:#15803D; background:linear-gradient(90deg,#15803D,#22C55E); -webkit-background-clip:text; background-clip:text; -webkit-text-fill-color:transparent;">Hired!</span>
    </h1>
    ...
    <p style="margin:0 0 24px 0; font-size:14px; line-height:1.6; color:#4B4B63; text-align:center;">
        Congratulations! You have been hired for the position below.
    </p>
        ...
        <tr>
            <td align="center" style="padding:18px 20px;">
                <p style="margin:0 0 8px 0; font-size:14px; color:#0E0F3B;">
                    <span style="color:#15803D; font-weight:700;">Position:</span> {{ $application->job->job_posting_title }}
                </p>
                @if ($application->job->employer?->employer_company_name)
                    <p style="margin:0; font-size:14px; color:#0E0F3B;">
                        <span style="color:#15803D; font-weight:700;">Company:</span> {{ $application->job->employer->employer_company_name }}
                    </p>
                @endif
            </td>
        </tr>
