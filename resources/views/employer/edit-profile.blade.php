        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-6xl font-['Montserrat']">
            ...
            <section class="bg-white rounded-3xl border border-gray-100 shadow-md p-10 flex flex-col items-center">
                ...
                <div class="w-full space-y-6">
                    <div>
                        <input type="text" placeholder="Enter full name..." class="w-full px-4 py-1.5 border border-[#0E0F3B] rounded-lg text-lg font-medium text-black focus:border-[#C73D1A] focus:ring-0 outline-none transition placeholder-gray-400">
                        <p class="text-[11px] font-bold text-[#12123B] uppercase tracking-tighter mt-1">Employer Name</p>
                    </div>

                    <div>
                        <input type="text" placeholder="e.g. HR Manager" class="w-full px-4 py-1.5 border border-[#0E0F3B] rounded-lg text-md font-medium text-gray-800 focus:border-[#C73D1A] focus:ring-0 outline-none transition placeholder-gray-400">
                        <p class="text-[11px] font-bold text-[#12123B] uppercase tracking-tighter mt-1">Employer Position</p>
                    </div>

                    <div class="space-y-4 pt-2">
                        <div>
                            <input type="email" placeholder="example@domain.com" class="w-full px-4 py-1.5 border border-[#0E0F3B] rounded-lg text-gray-800 text-md font-medium focus:border-[#C73D1A] focus:ring-0 outline-none transition placeholder-gray-400">
                            <p class="text-[11px] font-bold text-[#12123B] uppercase tracking-tighter mt-1">Email Address</p>
                        </div>
                        <div>
                            <input type="tel" placeholder="+63 XXX XXX XXXX" class="w-full px-4 py-1.5 border border-[#0E0F3B] rounded-lg text-gray-800 text-md font-medium focus:border-[#C73D1A] focus:ring-0 outline-none transition placeholder-gray-400">
                            <p class="text-[11px] font-bold text-[#12123B] uppercase tracking-tighter mt-1">Contact Number</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="bg-white rounded-3xl border border-gray-100 shadow-md p-10 flex flex-col items-center">
                ...
                <div class="w-full mb-8">
                    <input type="text" placeholder="Enter registered business name..." class="w-full px-4 py-1.5 border border-[#0E0F3B] rounded-lg font-medium focus:border-[#C73D1A] focus:ring-0 outline-none transition placeholder-gray-400 text-center">
                    <p class="text-[11px] font-bold text-[#12123B] uppercase tracking-tighter mt-1 text-center">Business Name</p>
                </div>

                <div class="grid grid-cols-2 gap-4 w-full">
                    <div>
                        <input type="text" placeholder="YYYY" class="w-full px-4 py-1.5 border border-[#0E0F3B] rounded-lg text-gray-800 text-md font-medium focus:border-[#C73D1A] focus:ring-0 outline-none transition placeholder-gray-400 text-center">
                        <p class="text-[10px] font-bold text-[#12123B] uppercase tracking-tighter leading-none mt-2">Year Established</p>
                    </div>
                    <div>
                        <input type="text" placeholder="e.g. 50-100" class="w-full px-4 py-1.5 border border-[#0E0F3B] rounded-lg text-gray-800 text-md font-medium focus:border-[#C73D1A] focus:ring-0 outline-none transition placeholder-gray-400 text-center">
                        <p class="text-[10px] font-bold text-[#12123B] uppercase tracking-tighter leading-none mt-2">Company Size</p>
                    </div>
                    <div>
                        <input type="text" placeholder="e.g. Technology" class="w-full px-4 py-1.5 border border-[#0E0F3B] rounded-lg text-gray-800 text-md font-medium uppercase focus:border-[#C73D1A] focus:ring-0 outline-none transition placeholder-gray-400 text-center">
                        <p class="text-[10px] font-bold text-[#12123B] uppercase tracking-tighter leading-none mt-2">Industry / Sector</p>
                    </div>
                    <div>
                        <input type="url" placeholder="www.website.com" class="w-full px-4 py-1.5 border border-[#0E0F3B] rounded-lg text-gray-800 text-md font-medium focus:border-[#C73D1A] focus:ring-0 outline-none transition placeholder-gray-400 text-center">
                        <p class="text-[10px] font-bold text-[#12123B] uppercase tracking-tighter leading-none mt-2">Website URL</p>
                    </div>
                </div>
            </section>
        </div>
