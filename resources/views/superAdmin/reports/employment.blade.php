        ...
        <main class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="dash-scroll">
                <div class="mb-4 flex items-center gap-3">
                    ...
                    <span class="section-heading bg-gradient-to-r from-[#0E0F3B] via-[#C73D1A] to-[#ED7A07] bg-clip-text text-transparent">Employment &amp; Alignment Report</span>
                </div>
                ...
                <div class="flex justify-end">
                    <a href="{{ route('reports.exportCsv', array_merge(['group' => 'employment'], array_filter($dashboardFilters))) }}"
