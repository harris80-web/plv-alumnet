        ...
        <div class="flex px-5 py-5 justify-between ">
            ...
            <div class="flex gap-4 font-[Montserrat] ">
                ...
                <nav id="footer-nav" class="flex flex-col justify-center text-[15px] font-semibold gap-1">
                    ...
                    <a href="{{ route('general.tou') }}"
                        class="{{ request()->routeIs('general.tou') ? 'text-[#ED7A07]' : 'hover:text-[#ED7A07]' }}">
                        TERMS OF USE
                    </a>
                    <a href="{{ route('general.faqs') }}"
                        class="{{ request()->routeIs('general.faqs') ? 'text-[#ED7A07]' : 'hover:text-[#ED7A07]' }}">
                        FAQs
                    </a>
                </nav>
            </div>
